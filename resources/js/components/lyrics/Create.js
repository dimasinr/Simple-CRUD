                ...
                <div className="card-body">
                    <form onSubmit={store}>
                        <div className="form-group">
                            ...
                            { errors.band ? <div className="text-danger mt-1">{errors.band[0]}</div> : '' }
                        </div>
                        {
                            albums.length ?
                            <div className="form-group">
                            ...
                            {errors.album ? <div className="text-danger mt-1">{errors.album[0]}</div> : '' }
                        </div> : ''
                        }
                        <div className="form-group">
                            <label htmlFor="title"> Song Title</label>
                            <input type="text" value={title} onChange={(e) => setTitle(e.target.value)} name="title" id="title" className="form-control"/>
                            {errors.title ? <div className="text-danger sm mt-1">{errors.title[0]}</div> : ''}
                        </div> 
                        <div className="form-group">
                            ...
                            {errors.body ? <div className="text-danger mt-1">{errors.body[0]}</div> : ''}
                        </div>
